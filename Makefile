...
sim: ## Run RTL simulation with cocotb
	...
	for d in $(SIM_DUTS); do \
		...
		\
		SRCS="src/gf180_sram_1r1w.sv src/voxel_*.sv src/input_fifo.sv src/evt2_decoder.sv src/uart_*.sv src/gray2bin.sv src/bin2gray.sv src/counter.sv src/delaybuffer.sv src/fifo_1r1w_cdc.sv src/ram_1r1w_sync.sv src/reg_cdc_sram_buffer.sv src/spi_control.sv"; \
		\

...
sim: ## Run RTL simulation with cocotb
	...
	for d in $(SIM_DUTS); do \
		...
		\
		SRCS="src/gf180_sram_1r1w.sv src/voxel_*.sv src/input_fifo.sv src/evt2_decoder.sv src/deprecated/uart_*.sv src/deprecated/voxel_bin_top.sv src/chip_flash_fsm.sv src/deprecated/gray2bin.sv src/deprecated/bin2gray.sv src/deprecated/counter.sv src/deprecated/delaybuffer.sv src/deprecated/fifo_1r1w_cdc.sv src/deprecated/ram_1r1w_sync.sv src/deprecated/reg_cdc_sram_buffer.sv src/deprecated/spi_control.sv src/selectable_debug.sv src/spi_wrapper.sv src/verilog_spi/*.v"; \
		\

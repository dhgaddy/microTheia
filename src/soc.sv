...
`endif
    ...
    input  logic SCLK, //no CDC or DLL needed if SCLK sufficiently slower than clk. target is 32 MHz SCLK (2:1 ratio vs 64 MHz core clock); metastability negligible on GF180MCU 180nm but no formal STA guarantee
